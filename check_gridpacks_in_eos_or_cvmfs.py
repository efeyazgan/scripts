...
requests=[]
requests = [
#'HIG-RunIISpring18wmLHEGS-00006',
]
...
#####################################################################################
        os.system('more '+my_path+'/'+prepid+'/'+'runcmsgrid.sh | grep -c "FORCE IT TO"')
        os.system('grep -c _CONDOR_SCRATCH_DIR '+my_path+'/'+prepid+'/'+'mgbasedir/Template/LO/SubProcesses/refine.sh')
        os.system('grep -c _CONDOR_SCRATCH_DIR '+my_path+'/'+prepid+'/'+'process/madevent/SubProcesses/refine.sh')
